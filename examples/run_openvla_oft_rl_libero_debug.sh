#!/bin/bash
# Debug script: Original SimpleVLA-RL parameters + n_samples=4 (WITHOUT TTRL)
# This helps isolate whether the problem is from TTRL code or parameter configuration
...
EXPERIMENT_NAME='DEBUG-4samples-no-ttrl'  # Test WITHOUT TTRL first
...
echo "Starting DEBUG run: Original params + n_samples=4 (NO TTRL)..."
